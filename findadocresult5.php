	...
	<body>
		...
		if (isset($_POST['part6']) && !empty($_POST['part6'])) {
			...
			if ($value == '--') {
				...
				$query = "SELECT * FROM `doctor` WHERE `tags` LIKE '%" . mysqli_real_escape_string($GLOBALS['conn'], $value) . "%'";
