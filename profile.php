					...
					<div class="doctor">
						...
						<table border="0">
							<tr>
								<td>Username</td>
								<td>
									<div class="FormElement1"><?php echo $visitor_username; ?></div>
								</td>
							</tr>
							<tr>
								<td>Your name</td>
								<td>
									<div class="FormElement1"><?php echo $visitor_name; ?></div>
								</td>
							</tr>
							...
							<tr>
								<td>Age</td>
								<td>
									<div class="FormElement1"><?php echo $visitor_email; ?></div>
								</td>
							</tr>
							<tr>
								<td>Age</td>
								<td>
									<div class="FormElement1"><?php echo $visitor_age; ?></div>
								</td>
							</tr>
							<tr>
								<td>Sex</td>
								<td>
									<div class="FormElement1"><?php echo $visitor_sex; ?></div>
								</td>
							</tr>
							<tr>
								<td>City</td>
								<td>
									<div class="FormElement1"><?php echo $visitor_city; ?></div>
								</td>
							</tr>
							<tr>
								<td>Secret Question</td>
								<td>
									<div class="FormElement1"><?php echo $visitor_que; ?></div>
								</td>
							</tr>
							<tr>
								<td>Your Answer</td>
								<td>
									<div class="FormElement1"><?php echo $visitor_ans; ?></div>
								</td>
							</tr>
					...
					<div class="user">
						...
						<form action="profile.php" method="POST" enctype="multipart/form-data">
							<table border="0">
								<tr>
									<td>Your Name</td>
									<td><input type="text" name="name" value="<?php echo $visitor_name; ?>"
											class="FormElement" required></td>
								</tr>
								<tr>
									<td>Choose a Username</td>
									<td><input type="text" name="username" value="<?php echo $visitor_username; ?>"
											class="FormElement" required></td>
								</tr>
								<tr>
									<td>Upload Your photo</td>
									<td><input type="file" name="file" class="file_upload" onClick="imageDown();"
											onChange="readURL(this,'img_prev_Photo');"></td>
								...
								<tr>
									...
									<td>
										<div id="imgDisplayPhoto" align="center"
											...
											<img id="img_prev_Photo" src="<?php echo $visitor_photo; ?>"
												alt="select a image" border="0" style="height:160px;width:120px;">
										</div>
									</td>
								...
								<tr>
									<td>Age</td>
									<td><input type="text" name="age" value="<?php echo $visitor_age; ?>"
											class="FormElementAge" maxlength="3" required></td>
								</tr>
								...
								<tr>
									<td>E-Mail</td>
									<td><input type="email" name="email" value="<?php echo $visitor_email; ?>"
											class="FormElement" required></td>
								</tr>

								<tr>
									<td>Enter current password</td>
									<td><input type="password" name="password_old" class="FormElement"
											placeholder="Always Required" required></td>
								</tr>
								<tr>
									<td>Enter New Password</td>
									<td><input type="password" name="password" class="FormElement"
											placeholder="Provide If you want to change"></td>
								</tr>

								<tr>
									<td>Confirm Password</td>
									<td><input type="password" name="confirmpassword" class="FormElement"
											placeholder="Provide If you want to change"></td>
								</tr>
